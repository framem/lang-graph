...
from node import triage_agent, triage_router, jira_agent, confluence_agent, status_agent, product_agent
...
if __name__ == "__main__":
    input_message = {
        "messages": [HumanMessage(content="Empfehle mir ein Produkt")]
